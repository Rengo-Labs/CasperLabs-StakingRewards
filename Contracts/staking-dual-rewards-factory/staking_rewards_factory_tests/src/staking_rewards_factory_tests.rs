...
fn deploy() -> (TestEnv, AccountHash, TestContract) {
    ...
    let staking_reward_factory_instance =
        STAKINGREWARDSFACTORYInstance::new(&env, "STAKINGREWARDSFACTORY", owner, 100.into());
...
fn test_deploy_1() {
    ...
    let staking_reward_factory_instance =
        STAKINGREWARDSFACTORYInstance::contract_instance(staking_reward_factory.clone());
    ...
    staking_reward_factory_instance.deploy(
        owner,
        Key::Account(owner),
        staking_token_key,
        reward_token_a_key,
...
fn test_update() {
    ...
    let staking_reward_factory_instance =
        STAKINGREWARDSFACTORYInstance::contract_instance(staking_reward_factory_instance);
    let staking_token = deploy_staking_token(&env, owner);
    let reward_token_a = deploy_reward_token_a(&env, owner);
    let reward_token_b = deploy_reward_token_b(&env, owner);
    ...
    staking_reward_factory_instance.update(
        owner,
        staking_token,
        U256::from(TEN_E_NINE * 10),
        U256::from(TEN_E_NINE * 10),
...
fn test_notify_reward_amounts() {
    let (env, owner, staking_reward_factory_instance) = deploy();
    let staking_reward_factory_package_hash: ContractPackageHash =
        staking_reward_factory_instance.query_named_key("self_package_hash".to_string());
    let staking_reward_factory_instance =
        STAKINGREWARDSFACTORYInstance::contract_instance(staking_reward_factory_instance);
    let staking_token = deploy_staking_token(&env, owner);
    let reward_token_a = deploy_reward_token_a(&env, owner);
...
fn test_pull_extra_tokens() {
    ...
    staking_reward_factory_instance.pull_extra_tokens(
        owner,
        staking_token,
        U256::from(TEN_E_NINE * 10),
    );
