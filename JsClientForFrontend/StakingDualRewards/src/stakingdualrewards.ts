...
class STAKINGDUALREWARDSClient {
  private contractName: string = "stakingdualrewards";
  private contractHash: string= "stakingdualrewards";
  private contractPackageHash: string= "stakingdualrewards";
  private namedKeys: {
    balances:string
  };
...
export default STAKINGDUALREWARDSClient ;
